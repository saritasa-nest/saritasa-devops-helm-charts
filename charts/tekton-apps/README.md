...
![Version: 0.2.15-dev.9](https://img.shields.io/badge/Version-0.2.15--dev.9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.29.0](https://img.shields.io/badge/AppVersion-v0.29.0-informational?style=flat-square)
...
|-----|------|---------|-------------|
| apps | list | `[{"argocd":{"labels":{"created-by":"xxx","ops-main":"xxx","ops-secondary":"xxx","pm":"xxx","tm":"xxx"},"namespace":"test"},"components":[{"applicationURL":"https://api.site.com","argocd":{"ignoreDeploymentReplicasDiff":true},"eventlistener":{"template":"buildpack-backend-build-pipeline-trigger-template"},"extraBuildConfigParams":{"KEY":"value"},"name":"backend","pipeline":"buildpack","repository":"xxx-backend","triggerBinding":[{"name":"docker_registry_repository","value":"XXX.dkr.ecr.us-west-2.amazonaws.com/xxx/dev/backend"},{"name":"buildpack_builder_image","value":"XXX.dkr.ecr.us-west-2.amazonaws.com/xxx/dev/buildpacks/google/builder:v1"},{"name":"buildpack_runner_image","value":"XXX.dkr.ecr.us-west-2.amazonaws.com/xxx/dev/buildpacks/google/runner:v1"},{"name":"buildpack_config_filename","value":"buildpack1.yml"},{"name":"project_config_filename","value":"project1.toml"},{"name":"sentry_project_name","value":"xxx-backend"}]},{"applicationURL":"https://site.com","argocd":{"ignoreDeploymentReplicasDiff":true},"eventlistener":{"enableWebhookSecret":false,"eventTypes":["pull_request","push"],"extraOverlays":[],"filter":"(body.ref.startsWith('refs/heads/develop') || body.ref.startsWith('refs/heads/release/'))","template":"buildpack-frontend-build-pipeline-trigger-template"},"extraBuildConfigParams":{},"name":"frontend","pipeline":"buildpack","repository":"xxx-frontend","triggerBinding":[{"name":"docker_registry_repository","value":"XXX.dkr.ecr.us-west-2.amazonaws.com/xxx/dev/frontend"},{"name":"buildpack_builder_image","value":"XXX.dkr.ecr.us-west-2.amazonaws.com/xxx/dev/buildpacks/paketo/builder:full"},{"name":"buildpack_runner_image","value":"XXX.dkr.ecr.us-west-2.amazonaws.com/xxx/dev/buildpacks/paketo/runner:full"},{"name":"source_subpath","value":"dist/web"},{"name":"buildpack_config_filename","value":"buildpack2.yml"},{"name":"project_config_filename","value":"project2.toml"},{"name":"sentry_project_name","value":"xxx-frontend"}]},{"applicationURL":"https://site.com","argocd":{"destinationNamespace":"wordpress","source":{"targetRevision":"15.2.4"}},"eventlistener":{"enableWebhookSecret":false,"eventTypes":["pull_request","push"],"extraOverlays":[],"filter":"(body.ref.startsWith('refs/heads/develop') || body.ref.startsWith('refs/heads/release/'))","template":"wordpress-build-pipeline-trigger-template"},"name":"wordpress","pipeline":"wordpress-build-pipeline","repository":"xxx-wordpress","wordpress":{"externalDatabase":{"database":"xxx-environment-wp","existingSecret":"xxx-wordpress-environment-externaldb","host":"xxx.rds.amazonaws.com","user":"xxx-environment-userwp"},"imageTag":"6.0.2","nodeSelector":{"apps":"true"},"podSecurityContext":{"enabled":false,"fsGroup":101},"repositoryRevision":"environment","repositorySshUrl":"git@github.com:saritasa-nest/xxx-wordpress.git","resources":{"limits":{"cpu":"1000m","memory":"1G"},"requests":{"cpu":"100m","memory":"128Mi"}}}}],"devopsMailList":"devops+xxx@saritasa.com","enabled":true,"extraApps":[{"argocd":{"destinationNamespace":"extra"},"path":"dev/argocd/apps","repoUrl":"git@github.com:saritasa-nest/nmbl-kubernetes-aws.git","targetRevision":"main"}],"jiraURL":"https://saritasa.atlassian.net/browse/xxx","kubernetesRepository":{"branch":"main","name":"xxx-kubernetes-aws","url":"git@github.com:saritasa-nest/xxx-kubernetes-aws.git"},"mailList":"xxx@saritasa.com","project":"xxx","slack":"client-xxx-ci","tektonURL":"https://tekton.site.com/#/namespaces/ci/pipelineruns"}]` | list of projects and the project's apps to be triggered |

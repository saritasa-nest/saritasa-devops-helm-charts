...
![Version: 0.1.16](https://img.shields.io/badge/Version-0.1.16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.28.2](https://img.shields.io/badge/AppVersion-v0.28.2-informational?style=flat-square)
...
|-----|------|---------|-------------|
| apps | list | `[{"argocd":{"labels":{"created-by":"DanilaKazakevich","ops-main":"DanilaKazakevich","ops-secondary":"RomanChubar","pm":"RomanGorbil","tm":"RomanGorbil"},"namespace":"saritasa-ar-conference-map"},"components":[{"applicationURL":"https://backend.saritasa-ar-conference-map.saritasa.rocks","eventlistener":{"template":"buildpack-django-build-pipeline-trigger-template"},"name":"backend","pipeline":"buildpack-django-build-pipeline","repository":"saritasa-ar-conference-map-backend","triggerBinding":[{"name":"docker_registry_repository","value":"965067289393.dkr.ecr.us-west-2.amazonaws.com/saritasa-ar-conference-map/backend"},{"name":"buildpack_builder_image","value":"public.ecr.aws/saritasa/buildpacks/google/builder:v1"},{"name":"buildpack_runner_image","value":"public.ecr.aws/saritasa/buildpacks/google/runner:v1"}]}],"devopsMailList":"devops+saritasa-ar-conference-map@saritasa.com","enabled":true,"environment":"prod","jiraURL":"https://saritasa.atlassian.net/browse/PC19","kubernetesRepository":{"branch":"main","name":"saritasa-ar-conference-map-kubernetes-aws","url":"git@github.com:saritasa-nest/saritasa-ar-conference-map-kubernetes-aws.git"},"mailList":"saritasa-ar-conference-map@saritasa.com","project":"saritasa-ar-conference-map","slack":"client-saritasa-ar-conference-map-ci","tektonURL":"https://tekton.saritasa.rocks/#/namespaces/ci/pipelineruns"}]` | list of projects and the project's apps to be triggered |

...
![Version: 0.2.0-dev.2](https://img.shields.io/badge/Version-0.2.0--dev.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.28.2](https://img.shields.io/badge/AppVersion-v0.28.2-informational?style=flat-square)
...
| eventlistener.namespaceSelector | list | `[]` | If specified, EventListener will look for triggers in these namespaces. Otherwise, only in its own namespace. |

...
![Version: 0.1.48-dev.ksenia.1](https://img.shields.io/badge/Version-0.1.48--dev.ksenia.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
- name: kaniko_extra_args
  value:
    - --build-arg=BASE_IMAGE=965067289393.dkr.ecr.us-west-2.amazonaws.com/saritasa/legacy/php:php71-smart-screen-base
```
